          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <div className="space-y-5 text-lg text-foreground/80 leading-relaxed">
                ...
                <p>
                  Vor über 20 Jahren habe ich begonnen, mich intensiver mit Seelenarbeit zu beschäftigen und eine Ausbildung zur Energetiktrainerin gemacht. Danach folgten weitere Ausbildungen in Reiki, doTERRA© AromaTouch und Lesen und Erschaffen im morphischen Feld.
                </p>
                <p>
